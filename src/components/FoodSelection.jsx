...
import { Search, ArrowUpDown, Plus, Minus, QrCode, X, AlertCircle } from 'lucide-react';
...
const FoodSelection = () => {
  ...
  useEffect(() => {
    const fetchFoodItems = async () => {
      try {
        setIsLoading(true);
        const response = await axios.get('http://localhost:2220/api/foods/');
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Select your favorite foods and track your calories with our intuitive food selection system.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <span className="text-indigo-600 font-medium">{item.calories} calories</span>
                    {item.protein && (
                  ...
                  {selectedItems.some((selected) => selected._id === item._id) ? (
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-medium text-gray-700">
                        {selectedItems.find((selected) => selected._id === item._id)?.quantity || 0}
                      </span>
                      <button
                        onClick={() => handleQuantityChange(item._id, 1)}
                        className="p-2 text-indigo-600 hover:bg-indigo-50 rounded-full transition-colors duration-200"
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl shadow-lg p-6 sticky top-8">
              <h2 className="text-2xl font-bold text-gray-800 mb-6">Selected Items</h2>
                ...
                <>
                  ...
                  <div className="border-t border-gray-200 pt-4 mb-6">
                    <div className="flex justify-between items-center text-lg font-semibold">
                      ...
                      <span className="text-indigo-600">{calculateTotalCalories()}</span>
                    </div>
                  </div>
